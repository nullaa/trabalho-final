...
def comprar(estoque,carrinho_compras,carrinho_compras_valor):#addicinanco produtos no carrinho
        ...
        index = int(input("Digite o codigo do produto: "))*2#multiplicando por dois a posiçao sempre podera escolher o produto pelo codigo 
    ...
    #return   carrinho_compras,carrinho_compras_valor
